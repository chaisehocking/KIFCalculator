...
+(id)scenarioToTestThatSubmitingTheFeedbackFormPostsTheFeedback{
	...
	[scenario addStep:[KIFTestStep stepToTapViewWithAccessibilityLabel:@"Feedback" traits:UIAccessibilityTraitButton]];
	[scenario addStep:[KIFTestStep stepToEnterText:@"Joe Blogs" intoViewWithAccessibilityLabel:@"Name" traits:UIAccessibilityTraitNone expectedResult:@"Joe Blogs"]];
	[scenario addStep:[KIFTestStep stepToEnterText:@"Joe.Blogs@gmail.com" intoViewWithAccessibilityLabel:@"Email" traits:UIAccessibilityTraitNone expectedResult:@"Joe.Blogs@gmail.com"]];
	...
	[scenario addStep:[KIFTestStep stepToEnterText:message intoViewWithAccessibilityLabel:@"Feedback Message" traits:UIAccessibilityTraitNone expectedResult:message]];
